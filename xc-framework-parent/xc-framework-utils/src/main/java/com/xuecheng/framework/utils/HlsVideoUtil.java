...
public class HlsVideoUtil extends  VideoUtil {
    ...
    String ffmpeg_path = "D:\\Program Files\\ffmpeg-2080227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\BaiduNetdiskDownload\\test.avi";
    String m3u8_name = "test.m3u8";
    String m3u8folder_path = "D:/BaiduNetdiskDownload/Movies/test/";
 ...
 /*
        ffmpeg -i  lucene.mp4   -hls_time 0 -hls_list_size 0   -hls_segment_filename ./hls/lucene_%05d.ts ./hls/lucene.m3u8
         */
...
//        commend.add("D:/BaiduNetdiskDownload/Movies/test/test_%05d.ts");
        commend.add(m3u8folder_path  + m3u8_name.substring(0,m3u8_name.lastIndexOf(".")) + "_%05d.ts");
//        commend.add("D:/BaiduNetdiskDownload/Movies/test/test.m3u8");
...
//            fileList.add(hls_relativepath+m3u8_name);
    ...
    public static void main(String[] args) throws IOException {
        String ffmpeg_path = "D:\\Program Files\\ffmpeg-2080227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        String video_path = "E:\\ffmpeg_test\\.mp4";
        String m3u8_name = ".m3u8";
        String m3u8_path = "E:\\ffmpeg_test\\\\";
