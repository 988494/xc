...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String mp4folder_path = "D:/BaiduNetdiskDownload/Movies/test/";
    ...
    public String generateMp4(){
        ...
        /*
        ffmpeg.exe -i  lucene.avi -c:v libx264 -s 280x720 -pix_fmt yuv420p -b:a 63k -b:v 753k -r 8 .\lucene.mp4
         */
        List<String> commend = new ArrayList<String>();
        //commend.add("D:\\Program Files\\ffmpeg-2080227-fa0c9d6-win64-static\\bin\\ffmpeg.exe");
        commend.add(ffmpeg_path);
        commend.add("-i");
//        commend.add("D:\\BaiduNetdiskDownload\\test.avi");
    ...
    public static void main(String[] args) throws IOException {
        String ffmpeg_path = "D:\\Program Files\\ffmpeg-2080227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        String video_path = "E:\\ffmpeg_test\\.avi";
